...
class MarketingAgent(SpecialistAgent):
    ...
    def role_instructions(self) -> str:
        return (
            ...
            "FLYER/POSTER/AD package MUST be SHORT: Headline (max 5 words), "
            "CTA (max 3 words). No body copy, no feature lists. "
            "The print engine makes three flyers — Blanco, Añejo, and the pair — "
            "using the official real bottles. Never invent a substitute bottle.\n"
